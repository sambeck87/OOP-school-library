...
**OOP school library**  a tool to record what books are in the library and who borrows them. This app allows you to:
...
- Go to this repo and copy the project link
        https://github.com/sambeck87/OOP-school-library
- Open your terminal and clone the repo with this command
```
git clone https://github.com/sambeck87/OOP-school-library.git
```
...
- [ ] **You will be able to know who has a book**
...
Feel free to check the [issues page](https://github.com/sambeck87/OOP-school-library/issues).
...
- **Do I need to install something to run this app?**

  - You need to install Ruby to run it
